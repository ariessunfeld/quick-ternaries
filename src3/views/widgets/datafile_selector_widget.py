...
if TYPE_CHECKING:
    from src3.controllers import TraceEditorController
...
from src3.views.widgets import ScrollableLabel
from src3.views.dialogs import DatafileSelectionDialog
