...
class TraceEditorController:
    ...
    def on_datafile_changed(self, new_file: str):
        ...
        if heatmap_combo:
            ...
            # Try to set the combobox to the saved value, but don't update the model
            # if the value isn't found - this preserves the saved value
            if current_value in numeric_cols:
                heatmap_combo.setCurrentText(current_value)
            elif numeric_cols:
                # Only set the UI combobox, don't modify the model (keep the saved value)
        ...
        if sizemap_combo:
            ...
            # Same fix here - preserve the model value
            if current_value in numeric_cols:
                sizemap_combo.setCurrentText(current_value)
            elif numeric_cols:
                # Only set the UI combobox, don't modify the model
