    ...
    def generate_plots(self):
        ...
        for target in elements:
            ...
            function setupHandlers() {
                ...
                try {
                    pyHandler.debugLog("Setting up handlers");
                } catch (e) {
                    console.error("Error calling debugLog:", e);
                }
                ...
                var checkPlotly = function() {
                    ...
                    plotDiv.on('plotly_hover', function(data) {
                        ...
                        // console.log('Hover:', lastHoverData);
                    });
                    
                    // Clear hover data when mouse leaves the plot area
                    plotDiv.on('plotly_unhover', function() {
                        // We actually keep the last hover data to improve double-click reliability
                        // lastHoverData = null;
                    });
                    ...
                    plotDiv.onclick = function(event) {
                        ...
                        try {
                            if (lastHoverData) {
                                ...
                                pyHandler.debugLog("Using hover data for click: " + 
                                                  "x=" + lastHoverData.x + ", " +
                                                  "y=" + lastHoverData.y);
                                ...
                                pyHandler.debugLog("Double-clicked cell: " + CATEGORY_COLUMN + "=" + categoryValue + 
                                ...
                                pyHandler.debugLog("No hover data available for click, using position");
                    ...
                    pyHandler.debugLog("Handlers installed successfully");
                };
