...
class MainWindow(QMainWindow):
    ...
    def generate_plots(self):
        ...
        for target in elements:
            ...
            # Add a hidden annotation to store the target element info.
            ...
            # The code waits until Plotly is defined and the plot div has the event API.
            js_code = """
<script>
...
"""
            ...
            html_str = fig.to_html(include_plotlyjs='cdn', full_html=True, div_id="plot", config={"doubleClick": False})
