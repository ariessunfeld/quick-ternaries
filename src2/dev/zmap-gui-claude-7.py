...
class MainWindow(QMainWindow):
    ...
    def generate_scatter_plot(self, facies, target, other):
        ...
        scatter_dialog.setWindowTitle(f"Scatter Plot: {target} vs {other} (Facies {facies_converted})")
        layout = QVBoxLayout(scatter_dialog)
        
        # Add a label at the top
        info_label = QLabel(f"Scatter Plot: {target} vs {other} for Facies {facies_converted}")
