...
#         # Reuse the formatter from TernaryPlotMaker for consistency
#         self.axis_formatter = AxisFormatter() if 'AxisFormatter' in globals() else None
...
#         if not axis_columns:
#             return 'Untitled Axis'
        
#         # Check if we have a formatter
