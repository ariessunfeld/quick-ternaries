...
from zmap_plot_maker_2 import ZmapPlotMaker  # used to be zmap_plot_maker.py not zmap_plot_maker_2.py
...
class MainWindow(QMainWindow):
    ...
    #         # Generate the zmap plot
    #         fig = self.zmap_plot_maker.make_plot(
    #             self.setupMenuModel, 
    ...
    #         # Get current target and category column for JS
    #         current_target = ""
    #         if self.zmap_plot_maker.heatmap_files and self.zmap_plot_maker.current_index < len(self.zmap_plot_maker.heatmap_files):
    #             current_target = self.zmap_plot_maker.heatmap_files[self.zmap_plot_maker.current_index][1]
    #         category_column = self.setupMenuModel.axis_members.categorical_column
            
    #         # Create HTML with JavaScript for double-click handling
    #         html = fig.to_html(include_plotlyjs=True, full_html=True, div_id="plot")
            
    #         # Add WebChannel script for communication with Python
    #         webchannel_js = """
    ...
    #                         } else {
    #                             zmapHandler.debugLog("No hover data available for double-click");
    #                         }
    #                     } catch (e) {
    ...
    #         }
    #         </script>
    #         """ % (current_target, category_column)
            
    #         # Insert the WebChannel script before the closing </head> tag
    #         html = html.replace("</head>", webchannel_js + "\n</head>")
            
    #         # Set the HTML in the web view - bypass the standard plotly logic for zmaps
    #         self.plotView.setHtml(html)
            
    #         # Set the QWebChannel for the page
    #         self.plotView.page().setWebChannel(self.zmap_channel)
            
    #         return
        
    #     elif current_plot_type == 'ternary':
    ...
    #     # Hide Zmap buttons for non-Zmap plot types
    #     self.zmapPrevButton.setVisible(False)
    #     self.zmapNextButton.setVisible(False)

    #     # Generate standard HTML with plotlyInterface for ternary/cartesian plots
    #     html = fig.to_html()
    #     javascript = """
    #         <script type="text/javascript" src="qrc:///qtwebchannel/qwebchannel.js"></script>
    #         <script type="text/javascript">
