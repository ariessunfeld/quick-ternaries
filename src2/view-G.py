...
class MainWindow(QMainWindow):
    ...
    def _on_page_loaded_for_export(self, success):
        print('on_page_loaded_for_export clicked')
        # Disconnect to avoid multiple callbacks
        self.plotView.loadFinished.disconnect(self._on_page_loaded_for_export)
        
        # if success:
        #     # Give Plotly time to initialize its toolbar
        #     # QTimer.singleShot(1000, self.click_camera_button)
    ...
    def on_export_clicked(self):
        ...
        if filepath:
            ...
            self.plot_config = {
                ...
                'displayModeBar': True,
                'displaylogo': False,
                # Add drawing tools [TODO debug why not adding correctly, need FigureEditor obj?]
