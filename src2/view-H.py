...
class MainWindow(QMainWindow):
    ...
    def handle_download(self, download):
        # For PySide6, we use these methods instead of setPath
        downloads_path = os.path.join(os.path.expanduser("~"), "Downloads")
        download.setDownloadDirectory(downloads_path)
        
        # Keep the original filename (newplot.png)
        # Or you can set a custom name with:
        # download.setDownloadFileName("my_custom_name.png")
    ...
    def show_save_dialog(self):
        # Define file filters for the dropdown
        file_filters = (
            "PNG Files (*.png);;"
            "JPEG Files (*.jpeg);;"
            "PDF Files (*.pdf);;"
        ...
        file_path, selected_filter = QFileDialog.getSaveFileName(
            ...
            file_filters  # the filter string
        )
    ...
    def on_export_clicked(self):
        ...
        # full_path_no_suffix = parent / stem
        # full_path_no_suffix = str(full_path_no_suffix)
        ...
        #         'scale': 8       # This multiplies the resolution (4x = very high resolution)
        #     },
        #     'displayModeBar': True,
        #     'displaylogo': False,
        ...
        # self.on_preview_clicked(config)

        # QTimer.singleShot(2000, self.click_camera_button)
    ...
    def on_preview_clicked(self, config=None):
        ...
        if not isinstance(config, dict) or 'toImageButtonOptions' not in config:
            config = {
                'toImageButtonOptions': {
                    'format': 'png',
                    'filename': 'TESTOUT',
