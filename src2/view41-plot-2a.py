...
class SetupMenuController:
    ...
    def update_axis_options(self):
        ...
        # Also update the hover_data selector in plot_labels section
        plot_labels_widgets = self.view.section_widgets.get("plot_labels", {})
        hover_data_widget = plot_labels_widgets.get("hover_data")
