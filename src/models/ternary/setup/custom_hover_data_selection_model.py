"""Ternary subclass of hover data selection model"""

from typing import List

from src.models.base.setup import BaseHoverDataSelectionModel

class TernaryHoverDataSelectionModel(BaseHoverDataSelectionModel):
    def __init__(
            self, 
            available_attrs: List[str] = None, 
            selected_attrs: List[str] = None):
        super().__init__(available_attrs, selected_attrs)
