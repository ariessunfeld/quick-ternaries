"""View where user can enter custom chemical formula to use for each apex column"""
...
class TernaryTraceMolarConversionView(QWidget):
    ...
    def __init__(self, parent: QWidget|None = None):
        ...
        self.chemical_label = QLabel('Valid Formula')
