...
class LeftLabeledImageComboBox(QWidget):
    """A labeled image ComboBox megawidget, for combo boxes containing images with QLabels to their left"""
    ...
    def addColorscaleIcons(self, colorscales: list[str]):
        ...
        self.addIcons(icons, colorscales, QSize(150, 15))
    ...
    def create_colorscale_icon(self, colorscale_name, width=150, height=15):
        ...
        heatmap_data = np.array([[i for i in range(width)]])
