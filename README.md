...
<pre> ```bibtex @misc{essunfeld2025quick, author = {Ari Essunfeld and Reid Morris}, title = {Quick Ternaries: v0.5.3}, year = {2025}, publisher = {Zenodo}, version = {v0.5.3}, doi = {10.5281/zenodo.14511221}, url = {https://doi.org/10.5281/zenodo.14511221}, note = {Open-source software package}, howpublished = {Software available from Zenodo} } ``` </pre>
